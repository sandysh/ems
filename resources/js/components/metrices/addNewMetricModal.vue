<template>
    <div class="col-md-4">
        <div class="modal fade show" style="display: block;" id="modal-form" tabindex="-1" aria-modal="true"
                    ...
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            ...
                            <div v-if="errorsStore.show" class="alert alert-danger mx-3" role="alert">
                                <li class="text-white" v-for="(error, index) in errorsStore.list" :key="index">{{ error
                                    }}</li>
                            </div>
                            <div class="card-body">
                                <form action="" method="post" autocomplete="false">
                                    <div class="card-body px-0 pt-0 pb-2">
                                        <div class="form-group">
                                            ...
                                            <input v-model="data.name" name="first_name" class="form-control"
                                                type="text" value="" id="first-name">
                                        </div>
                                        <div class="form-group">
                                            <label for="score" class="form-control-label">Score</label>
                                            <input v-model="data.score" name="score" class="form-control" type="number"
                                                value="" id="score">
                                        </div>
                                        <div class="form-check form-switch">
                                            <input v-model="data.is_active" name="is_active" class="form-check-input"
